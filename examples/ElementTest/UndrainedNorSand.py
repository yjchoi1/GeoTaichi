...
pressure = 100  # kPa
save_path = f"examples/ElementTest/UndrainedNorSand/{int(pressure)}kpa"
...
mpm.scene.boundary.velocity_boundary[0].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[1].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[3].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[4].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[6].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[7].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[8].velocity = -velocity
...
mpm.scene.boundary.velocity_boundary[9].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[10].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[11].velocity = -velocity
...
mpm.scene.boundary.velocity_boundary[12].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[13].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[14].velocity = velocity
...
mpm.scene.boundary.velocity_boundary[15].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[16].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[17].velocity = velocity
...
mpm.scene.boundary.velocity_boundary[18].velocity = -velocity/2
...
mpm.scene.boundary.velocity_boundary[19].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[20].velocity = velocity
...
mpm.scene.boundary.velocity_boundary[21].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[22].velocity = velocity/2
...
mpm.scene.boundary.velocity_boundary[23].velocity = velocity
