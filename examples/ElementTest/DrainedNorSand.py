...
mpm.set_solver(solver={
                           ...
                           "SimulationTime":             80,
                           "SaveInterval":               0.3,
                           "SavePath":                   f"examples/ElementTest/DrainedNorSand/{int(pressure/1000)}kpa"
                      })
...
mpm.add_material(model="NorSand",
                 material={
                               ...
                               "PoissonRatio": 0.2,  # typical for sands
                               ...
                               "G_max": 40e6,  # max shear modulus (Pa) (30~100 GPa)
                               "p_ref": 100e3,  # reference pressure (Pa) (50~1000 kPa)
...
mpm.postprocessing(
    read_path= f"examples/ElementTest/DrainedNorSand/{int(pressure/1000)}kpa",
